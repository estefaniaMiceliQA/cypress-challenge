Feature: Home Page
  ...
  Scenario: User sees the home page correctly
    ...
    And I should see the main header "Welcome to E-Commerce"
    And I should see a list of products

  Scenario: Each product should have a name and a price
    Given I visit the home page
  ...
  Scenario: Product names should only contain letters, numbers, and spaces
    Given I visit the home page
